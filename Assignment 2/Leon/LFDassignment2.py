...
def main():
    ...
    # IMPORTANT NOTE FOR LfD reviewers/lecturers:
    # - the code here below is commented, since it is
    #   not very useful for you to perform the grid search
    # - when you run the code, the classification pipeline
    #   uses the best parameters, courtesy of a previously
    #   run grid search by me :D
