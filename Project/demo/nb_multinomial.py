...
def main():
    ...
    if not os.path.isdir('results'):
        os.mkdir('results')
    results.to_excel("results/nb_multinomial.xlsx", engine='openpyxl')
    results.to_html("results/nb_multinomial.html")

    joblib.dump(classifier, "models/nb_multinomial.joblib")
