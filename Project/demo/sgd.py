...
AMERICAN_NEWSPAPERS = {'The Washington Post'}  #, 'The New York Times'}
...
def main():
    ...
    if not os.path.isdir('results'):
        os.mkdir('results')
    results.to_excel("results/sgd.xlsx", engine='openpyxl')
    results.to_html("results/sgd.html")

    joblib.dump(classifier, "models/sgd.joblib")
